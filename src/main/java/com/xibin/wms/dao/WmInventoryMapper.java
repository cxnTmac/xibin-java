...
public interface WmInventoryMapper extends BaseMapper{
    ...
    List<WmInventoryQueryItem> selectByKey(@Param("skuCode")String orderNo,@Param("locCode")String locCode,@Param("lot")String lot,@Param("companyId")String companyId,@Param("warehouseId")String warehouseId);
