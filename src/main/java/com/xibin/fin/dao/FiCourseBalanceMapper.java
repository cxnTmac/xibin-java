...
public interface FiCourseBalanceMapper extends BaseMapper{
    ...
    List<FiCourseBalance> selectByKey(@Param("period")String period,@Param("courseNo")String courseNo,@Param("companyId")String companyId,@Param("bookId")String bookId);
