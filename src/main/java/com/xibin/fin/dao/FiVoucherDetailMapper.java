...
public interface FiVoucherDetailMapper extends BaseMapper {
	...
	List<FiVoucherDetail> selectByKey(@Param("voucherId") String voucherId, @Param("lineNo") String lineNo,
	...
	List<FiVoucherDetailAuxiliarySumQueryItem> selectByVoucherIdForAuxiliarySum(@Param("voucherId") String voucherId);
